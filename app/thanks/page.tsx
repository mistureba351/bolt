...
export default function ThanksPage() {
  ...
  const reportItems = [
    ...
    "Données de localisation exactes et activité de rencontres",
    "Chronologie détaillée des activités et habitudes",
  ]

  const processSteps = [
    { icon: CheckCircle, label: "Paiement Confirmé", status: "completed" },
    { icon: Clock, label: "Traitement du Rapport", status: "current" },
    { icon: Mail, label: "Livraison par Email", status: "pending" },
  ]
        ...
        >
          ...
          <Card className="bg-white/95 backdrop-blur-sm shadow-2xl">
            <CardContent className="p-8">
              ...
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">📩 Livraison du Rapport Complet</h2>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 leading-relaxed">
                      Veuillez vérifier régulièrement votre email, y compris votre dossier spam/courrier indésirable. Le rapport sera envoyé depuis une
                      adresse email sécurisée.
                      <br />
                      <strong>Si vous ne le recevez pas dans les 7 jours, veuillez contacter notre équipe de support.</strong>
                    </p>
                  </div>
                </div>
              </motion.div>
          ...
          >
            <p>
              ...
              <a href="mailto:support@whatsappsecrets.fr" className="text-blue-400 hover:underline">
                support@whatsappsecrets.fr
              </a>
            </p>
          </motion.div>
        </motion.div>
